...
export async function POST(request: Request) {
  try {
    ...
    const listing = {
      ...
      kt: body.kt !== null && body.kt !== undefined ? Number(body.kt) : null,
      km: body.km !== null && body.km !== undefined ? Number(body.km) : null,
      harga: body.harga !== null && body.harga !== undefined ? Number(body.harga) : null,
